...
public class ContractOV {
    private int productNum ;
    private int extNum;
    private List<ContractProductOV> contractProductOVS;  //合同下的
    ...
    public List<ContractProductOV> getContractProductOVS() {
        return contractProductOVS;
    }

    public void setContractProductOVS(List<ContractProductOV> contractProductOVS) {
        this.contractProductOVS = contractProductOVS;
    }
