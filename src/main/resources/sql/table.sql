...
(
  EXPORT_ID         VARCHAR(40) NOT NULL PRIMARY KEY,
  INPUT_DATE        TIMESTAMP(6),
  CONTRACT_IDS      VARCHAR(500),
  CUSTOMER_CONTRACT VARCHAR(200),
  LCNO              VARCHAR(10),
  CONSIGNEE         VARCHAR(100),
  MARKS             VARCHAR(1000),
  REMARK            VARCHAR(100),
  SHIPMENT_PORT     VARCHAR(100),
  DESTINATION_PORT  VARCHAR(100),
  TRANSPORT_MODE    VARCHAR(10),
  PRICE_CONDITION   VARCHAR(10),
  STATE             INTEGER,
  GROSS_WEIGHT      FLOAT(5,2),
  NET_WEIGHT        FLOAT(5,2),
  MEASUREMENT       FLOAT(8,2),
  CREATE_BY         VARCHAR(40),
  CREATE_DEPT       VARCHAR(40),
...
(
  EXPORT_PRODUCT_ID VARCHAR(40) NOT NULL PRIMARY KEY,
  ...
  Cfloat           INTEGER,
  BOX_NUM           INTEGER,
  GROSS_WEIGHT      FLOAT(8,2),
  NET_WEIGHT        FLOAT(8,2),
  SIZE_LENGTH       FLOAT(8,2),
  SIZE_WIDTH        FLOAT(8,2),
  SIZE_HEIGHT       FLOAT(8,2),
  EX_PRICE          FLOAT(8,2),
  PRICE             FLOAT(10,2),
  TAX               FLOAT(8,2),
  ORDER_NO          INTEGER
...
(
  EXT_EPRODUCT_ID   VARCHAR(40) NOT NULL PRIMARY KEY,
  EXPORT_PRODUCT_ID VARCHAR(40),
  FACTORY_ID        VARCHAR(40),
  FACTORY_NAME      VARCHAR(50),
  CTYPE             INTEGER,
  PRODUCT_NO        VARCHAR(50),
